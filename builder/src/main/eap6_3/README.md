...
Get the proper WAR file (e.g. dashbuilder-eap-6_3.war) and execute the following command:

    $ cd <jboss_home>/bin
    $ ./jboss-cli.sh --connect --command="deploy <path_to_war_file>"

    <path_to_war_file>: is the local path to the application war file.
    e.g. $ ./jboss-cli.sh --connect --command="deploy /home/myuser/myfiles/dashbuilder-eap-6_3.war" )
...
* Modify the file *dashboard-builder/builder/src/main/eap6_3/WEB-INF/jboss-web.xml*:
...
* Modify the file *dashboard-builder/builder/src/main/eap6_3/WEB-INF/jboss-deployment-structure.xml*.
...
* The application roles are defined at [builder/src/main/eap6_3/WEB-INF/web.xml](https://github.com/droolsjbpm/dashboard-builder/blob/master/builder/src/main/eap6_3/WEB-INF/web.xml) file.
Roles can be used to create access profiles and define custom authorization policies.

* The application uses the JBoss' default security domain as you can see [here](https://github.com/droolsjbpm/dashboard-builder/blob/master/builder/src/main/eap6_3/WEB-INF/jboss-web.xml).
