...
@Install
@BarAndLineChart
public class BarAndLineChartDisplayerType extends AbstractChartDisplayerType {

    public static final String UID = "barandlinechart";

    @Inject @Config(UID)
    protected String uid;

    @Inject @Config(value="components/bam/images/barandline.png")
    protected String iconPath;

    @Inject @Install @BarAndLineChart
    ...
    public DataDisplayer createDataDisplayer() {
        BarAndLineChartDisplayer displayer = new BarAndLineChartDisplayer();
