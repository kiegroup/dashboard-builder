...
@Install
@GanttChart
public class GanttChartDisplayerType extends AbstractChartDisplayerType {

    public static final String UID = "ganttchart";

    @Inject @Config(UID)
    protected String uid;

    @Inject @Config(value="components/bam/images/gantt.png")
    protected String iconPath;

    @Inject @Install @GanttChart
    ...
    public String getDescription(Locale l) {
        ...
        return i18n.getString("ganttChartDisplayer.ganttDescription");
    }

    public DataDisplayer createDataDisplayer() {
        GanttChartDisplayer displayer = new GanttChartDisplayer();
