...
@Install
@ProgressBarChart
public class ProgressBarChartDisplayerType extends AbstractChartDisplayerType {

    public static final String UID = "progressbarchart";

    @Inject @Config(UID)
    protected String uid;

    @Inject @Config(value="components/bam/images/progressbar.png")
    protected String iconPath;

    @Inject @Install @ProgressBarChart
    ...
    public String getDescription(Locale l) {
        ...
        return i18n.getString("progressBarChartDisplayer.progressBarDescription");
    }

    public DataDisplayer createDataDisplayer() {
        ProgressBarChartDisplayer displayer = new ProgressBarChartDisplayer();
