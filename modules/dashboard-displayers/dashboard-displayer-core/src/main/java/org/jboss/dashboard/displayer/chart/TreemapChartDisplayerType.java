...
@Install
@TreemapChart
public class TreemapChartDisplayerType extends AbstractChartDisplayerType {

    public static final String UID = "treemapchart";

    @Inject @Config(UID)
    protected String uid;

    @Inject @Config(value="components/bam/images/treemap.png")
    protected String iconPath;

    @Inject @Install @TreemapChart
    ...
    public DataDisplayer createDataDisplayer() {
        TreemapChartDisplayer displayer = new TreemapChartDisplayer();
