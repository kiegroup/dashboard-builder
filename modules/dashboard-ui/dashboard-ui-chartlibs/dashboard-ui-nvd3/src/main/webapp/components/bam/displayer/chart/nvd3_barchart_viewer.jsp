...
<%@ page import="org.jboss.dashboard.ui.components.chart.NVD3BarChartViewer" %>
<%
  NVD3ChartViewer viewer = CDIBeanLocator.getBeanByType(NVD3BarChartViewer.class);
...
<iframe
    ...
    src="<%=basehref %>components/bam/displayer/chart/nvd3_barchart_viewer_iframe.jsp?chartId=<%=chartId%>">
</iframe>
<%
  } else {
%>
