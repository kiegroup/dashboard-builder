...
<head>
  ...
  <script src="<%=reqContext%>/components/bam/displayer/chart/nvd3/src/models/line.js" type="text/javascript"></script>
  <script src="<%=reqContext%>/components/bam/displayer/chart/nvd3/src/models/lineChart.js" type="text/javascript"></script>
  <script src="<%=reqContext%>/components/bam/displayer/chart/progressBar.js" type="text/javascript"></script>
...
<%@include file="nvd3_progressbarchart_script.jsp"%>
</body>
</html>
