...
public class PanelInstanceI18nPropertiesFormatter extends PanelInstancePropertiesFormatter {
    ...
    public void setHandler(PanelInstanceI18nPropertiesHandler handler) {
    ...
    public PanelProviderParameter[] getPanelProviderParameters() throws Exception {
        return ((WorkspaceImpl) getWorkspacesManager().getWorkspace(handler.getWorkspaceId())).getPanelInstance(handler.getPanelInstanceId()).getI18nParameters();
    }
