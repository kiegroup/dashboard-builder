...
public class PanelInstanceSpecificPropertiesFormatter extends PanelInstancePropertiesFormatter {
    ...
    public void setHandler(PanelInstanceSpecificPropertiesHandler handler) {
    ...
    public PanelProviderParameter[] getPanelProviderParameters() throws Exception {
        return ((WorkspaceImpl) getWorkspacesManager().getWorkspace(handler.getWorkspaceId())).getPanelInstance(handler.getPanelInstanceId()).getCustomParameters();
    }
