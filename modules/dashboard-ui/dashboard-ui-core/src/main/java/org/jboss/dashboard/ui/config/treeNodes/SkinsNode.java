...
public class SkinsNode extends AbstractNode {
    private static transient org.apache.commons.logging.Log log = org.apache.commons.logging.LogFactory.getLog(SkinsNode.class.getName());
    ...
    public boolean onEdit() {
        resourcesPropertiesHandler.setResourceType("skin");
