...
public class Section implements Comparable, Visitable {
     ...
     * Logger
     */
    private static org.apache.commons.logging.Log log = org.apache.commons.logging.LogFactory.getLog(Section.class.getName());
    ...
    public Set getPanels() {
        return panels;
    }

    public void setPanels(Set panels) {
        this.panels = panels;
    }
