...
<%@ page import="org.jboss.dashboard.displayer.chart.BarAndLineChartDisplayer" %>
<%@ page import="org.jboss.dashboard.ui.components.chart.BarAndLineChartEditor" %>
...
<%
    BarAndLineChartEditor editor = (BarAndLineChartEditor) UIBeanLocator.lookup().getCurrentBean(request);
    request.setAttribute("editor", editor);

    BarAndLineChartDisplayer displayer = (BarAndLineChartDisplayer) editor.getDataDisplayer();
