...
<%@ page import="org.jboss.dashboard.ui.components.chart.GanttChartEditor"%>
<%@ page import="org.jboss.dashboard.LocaleManager" %>
<%@ page import="org.jboss.dashboard.displayer.chart.GanttChartDisplayer" %>
...
<%
    GanttChartEditor editor = (GanttChartEditor) UIBeanLocator.lookup().getCurrentBean(request);
    request.setAttribute("editor", editor);

    GanttChartDisplayer displayer = (GanttChartDisplayer) editor.getDataDisplayer();
