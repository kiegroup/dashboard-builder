...
<%@ page import="org.jboss.dashboard.displayer.chart.Line2ChartDisplayer" %>
<%@ page import="org.jboss.dashboard.ui.components.chart.Line2ChartEditor" %>
...
<%
    Line2ChartEditor editor = (Line2ChartEditor) UIBeanLocator.lookup().getCurrentBean(request);
    request.setAttribute("editor", editor);

    Line2ChartDisplayer displayer = (Line2ChartDisplayer) editor.getDataDisplayer();
