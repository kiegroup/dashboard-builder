...
<%@ page import="org.jboss.dashboard.ui.components.chart.ProgressBarChartEditor"%>
<%@ page import="org.jboss.dashboard.LocaleManager" %>
<%@ page import="org.jboss.dashboard.displayer.chart.ProgressBarChartDisplayer" %>
...
<%
    ProgressBarChartEditor editor = (ProgressBarChartEditor) UIBeanLocator.lookup().getCurrentBean(request);
    request.setAttribute("editor", editor);

    ProgressBarChartDisplayer displayer = (ProgressBarChartDisplayer) editor.getDataDisplayer();
...
<table width="100%" cellspacing="2">
    <tr>
        ...
        <td align="right" valign="top">
			...
			<%
			boolean useProgressColumns = false;
			if (displayer.isUseProgressColumns()) useProgressColumns = true;
			%>
			<input name="useProgressColumns" id="<factory:encode name="useProgressColumns"/>" type="hidden" value="true" <%=useProgressColumns ? "checked" : ""%> >
        </td>
        <td valign="top">
            <!-- Include the viewer  -->
