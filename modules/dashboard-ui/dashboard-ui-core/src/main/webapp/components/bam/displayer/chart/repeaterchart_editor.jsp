...
<%@ page import="org.jboss.dashboard.displayer.chart.RepeaterChartDisplayer" %>
<%@ page import="org.jboss.dashboard.ui.components.chart.RepeaterChartEditor" %>
...
<%
    RepeaterChartEditor editor = (RepeaterChartEditor) UIBeanLocator.lookup().getCurrentBean(request);
    request.setAttribute("editor", editor);

    RepeaterChartDisplayer displayer = (RepeaterChartDisplayer) editor.getDataDisplayer();
